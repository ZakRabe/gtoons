...
export class GameState1635303149935 implements MigrationInterface {
    name = 'GameState1635303149935'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `game` ADD `gameStateId` int NULL");
        await queryRunner.query("ALTER TABLE `game` ADD UNIQUE INDEX `IDX_edb1000a9204a0d8345a193b53` (`gameStateId`)");
        ...
        await queryRunner.query("CREATE UNIQUE INDEX `REL_edb1000a9204a0d8345a193b53` ON `game` (`gameStateId`)");
        ...
        await queryRunner.query("ALTER TABLE `game` ADD CONSTRAINT `FK_edb1000a9204a0d8345a193b538` FOREIGN KEY (`gameStateId`) REFERENCES `gamestate`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `game` DROP FOREIGN KEY `FK_edb1000a9204a0d8345a193b538`");
        ...
        await queryRunner.query("DROP INDEX `REL_edb1000a9204a0d8345a193b53` ON `game`");
        ...
        await queryRunner.query("ALTER TABLE `game` DROP INDEX `IDX_edb1000a9204a0d8345a193b53`");
        await queryRunner.query("ALTER TABLE `game` DROP COLUMN `gameStateId`");
