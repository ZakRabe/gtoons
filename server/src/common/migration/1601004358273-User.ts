...
export class User1601004358273 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'CREATE TABLE `profile` (`id` int NOT NULL AUTO_INCREMENT, `displayName` varchar(255) NOT NULL, `title` varchar(255) NULL, `profilePic` varchar(255) NULL, `profilePicType` varchar(255) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB'
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE `user` ADD `profilePicType` varchar(255) NULL'
    );
    await queryRunner.query(
      'ALTER TABLE `user` ADD `profilePic` varchar(255) NULL'
    );
