  ...
  render() {
    ...
    return (
      <div style={this.getCardStyle()}>
        <div style={{margin:'7px',height:'50px',width:'50px',borderRadius:'50%',backgroundColor:cardColor}}>
          <p style={{textAlign:'center',color:'white',margin:'0',paddingTop:'5px',fontSize:'25pt',fontWeight:'bold'}}>{cardScore}</p>
        </div>
      </div>
    );
  }
